...
/**
 * An {@link remixlab.bias.core.Agent} that handles {@link remixlab.bias.branch.MotionBranch}es (see
 ...
 * </ol>
 */
public abstract class GenericMotionAgent extends GenericAgent {
	 ...
	 */
	public GenericMotionAgent(InputHandler inputHandler, String name) {
	...
	/**
	 * @param name of the {@link remixlab.bias.branch.MotionBranch} to be appended.
	 * 
	 * @return the appended {@link remixlab.bias.branch.MotionBranch}.
	 */
