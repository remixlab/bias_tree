...
public class Agent {
	 ...
	 * grabber, K branch) { // Overkill but feels safer ;) if (grabber == null || this.hasGrabber(grabber) || branch ==
	 * null) return false; if (!hasBranch(branch)) this.appendBranch(branch); tuples.add(new GrabberBranchTuple(grabber,
	 * branch)); return true; } //
	 */
