...
public abstract class AxisPlaneConstraint extends Constraint {
	 ...
	 * <p>
	 * Use {@link remixlab.dandelion.geom.Frame#setPosition(Vec)} to define the position of the constrained Frame before
	 * it gets constrained.
	 */
	 ...
	 * <p>
	 * Use {@link remixlab.dandelion.geom.Frame#setOrientation(Rotation)} to define the orientation of the constrained
