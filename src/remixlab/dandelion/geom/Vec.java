...
public class Vec implements Constants, Linkable {
	...
	/**
	 * Calculate the squared magnitude of the vector Faster if the real length is not required in the case of comparing
	 * vectors, etc.
	 * 
	...
	/**
	 * Perform cross product between this and another vector, and store the result in 'target'. If target is null, a new
	 * vector is created.
	 */
	 ...
	 * @param amt
	 *          The amt parameter is the amount to interpolate between the two vectors where 1.0 equal to the new vector
