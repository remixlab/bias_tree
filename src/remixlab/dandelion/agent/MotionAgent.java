...
public class MotionAgent<A extends Action<?>> extends InputAgent {
	...
	public MotionAgent(AbstractScene scn, String n) {
		...
		scene = scn;
		eyeAgent = new ActionWheeledMotionAgent<MotionProfile<DOF1Action>, MotionProfile<A>, ClickProfile<ClickAction>>(
		...
		frameAgent = new ActionWheeledMotionAgent<MotionProfile<DOF1Action>, MotionProfile<A>, ClickProfile<ClickAction>>(
				new MotionProfile<DOF1Action>(),
				new MotionProfile<A>(),
