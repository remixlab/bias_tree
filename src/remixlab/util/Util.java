...
public class Util {
	...
	/**
	 * Calculates a number between two numbers at a specific increment. The {@code amt} parameter is the amount
	 * to interpolate between the two values where 0.0 equal to the first point, 0.1 is very near the first point,
