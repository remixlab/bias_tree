 ...
 * {@link remixlab.proscene.InteractiveFrame#checkIfGrabsInput(float, float)}. Note that the drawing could
 * thus take place at least into the {@link remixlab.proscene.Scene#pg()} and the
 ...
 * {@link remixlab.proscene.InteractiveFrame} provides default 2D/3D high-level interactivity.
 * <p>
...
public interface Model extends Grabber /* , Animator */{
	/**
	 * While displaying a model requires the drawing to be rendered into {@link remixlab.proscene.Scene#pg()},
