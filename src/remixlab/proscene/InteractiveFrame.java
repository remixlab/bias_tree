 ...
 * (see all the <b>*Binding*()</b> methods).
 * <p>
...
public class InteractiveFrame extends GenericP5Frame {	
	 ...
	 * {@link remixlab.proscene.Scene#frames()} collection. Calls {@code super(scn, referenceFrame}.
	 * 
	 ...
	 * and then added to the {@link remixlab.proscene.Scene#frames()} collection. Calls {@code super(scn, referenceFrame}.
	 * 
	 * @see remixlab.dandelion.core.GenericFrame#GenericFrame(AbstractScene, Frame)
	 * @see remixlab.proscene.Scene#addFrame(InteractiveFrame)
	 * @see #addGraphicsHandler(Object, String)
	...
	/**
	 * Internal use. Frame graphics color to use in the {@link remixlab.proscene.Scene#pickingBuffer()}.
	 */
	...
	/**
	 * Draw the visual representation of the frame into the given PGraphics using the current point of view
	 * (see {@link remixlab.proscene.Scene#applyWorldTransformation(PGraphics, Frame)}).
	 * <p>
	 * This method is internally called by the scene to {@link remixlab.proscene.Scene#drawFrames(PGraphics)} into
	 * the {@link remixlab.proscene.Scene#disablePickingBuffer()} and by {@link #draw()} to draw the frame into
	 * the scene main {@link remixlab.proscene.Scene#pg()}.
	 */
	...
	/**
	 * Internal use. Invokes an external drawing method (if registered). Called by {@link #draw(PGraphics)}.
	 */
	...
	/**
	 * Attempt to add a graphics handler method to the frame. The default event handler is a method that
