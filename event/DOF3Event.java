...
public class DOF3Event extends MotionEvent {
 ...
 @Override public DOF3Event get() {
  return new DOF3Event(this);
 }

 @Override public DOF3Event flush() {
  return (DOF3Event) super.flush();
 }

 @Override public DOF3Event fire() {
  return (DOF3Event) super.fire();
 }

 @Override protected void setPreviousEvent(MotionEvent prevEvent) {
  rel = true;
  if (prevEvent != null)
 ...
 @Override public void modulate(float[] sens) {
  if (sens != null)
